        ...
        <div class="page-wrapper">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user-menu">
                                <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                                    ...
                                    <span class="d-none d-lg-inline-block">Syahmi</span>
                                </button>
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <!-- User image -->
                                    <li class="dropdown-header">
                                        ...
                                        <div class="d-inline-block">
                                            Syahmi <small class="pt-1">syahmim4a1@gmail.com</small>
                                        </div>
                                    </li>
            ...
            <footer class="footer mt-auto">
                <div class="copyright bg-white">
                    <p>
                        &copy; <span id="copy-year">2019</span> Copyright Inventorium by
                        <a class="text-primary" href="http://www.iamabdus.com/" target="_blank">Mr Nope</a>.
                    </p>
                </div>
                <script>
                    var d = new Date();
